...
sc1 <- ggtree(tr) %<+% d1 + aes(color=I(color)) + geom_tiplab() + xlim(0,3)
sc2 <- ggtree(tr) %<+% d1 + aes(color=I(color2)) + geom_tiplab() + xlim(0,3)
...
suntree <- ggtree(sunfish.tree) + geom_tiplab() + xlim_tree(.5)
